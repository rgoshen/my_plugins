...
Delegate to the **session-state-manager** skill, **arch mode**, running the **LOAD** phase.
...
The user signals they're done. Delegate to the **session-state-manager** skill, **arch mode**, running the **SAVE** phase.
